 ...
 * Ported from FrACT10 MiscSpace.j — pixel↔mm↔degree conversions.
 */
import { getSetting, getPixelsPerMM } from '../core/Settings';
import { CAL_BAR_LENGTH_PX } from '../core/Globals';
